...
const Klass = require('../../main/practice-3/class');
...
describe("Student", () => {
  ...
  () => {
    let clazz = new Klass(2);
    let student = new Student("Tom", 21, clazz, '001');
    clazz.appendMember(student);
